...
public class mainFrame extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            try {
                String serverIp = JOptionPane.showInputDialog("Enter server IP:").trim();

                accountService = (Account) Naming.lookup("//"+serverIp+":5200/AccountService");
...
class WithdrawFrame extends JFrame {
    ...
    public WithdrawFrame(String action) {
        // try {
        //     accountService = (Account) Naming.lookup("rmi://"+getServerIp()+":5200/AccountService");
        // } catch (Exception e) {
